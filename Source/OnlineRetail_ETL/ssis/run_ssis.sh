...
CONN="Provider=MSOLEDBSQL;Data Source=localhost;Initial Catalog=RetailDW;User ID=sa;Password=${MSSQL_SA_PASSWORD};Encrypt=Optional;TrustServerCertificate=True;"
echo '[INFO] Running native Linux SSIS/dtexec.'
"$DTEXEC" /F "$PACKAGE" /CONNECTION "RetailDW;\"$CONN\"" /REPORTING E
