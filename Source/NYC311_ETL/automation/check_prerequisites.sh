...
check python3 'command -v python3'; check sqlcmd 'sqlcmd_path'; check dtexec 'dtexec_path'; check sqlservr 'test -x /opt/mssql/bin/sqlservr'; check SSIS 'test -x /opt/ssis/bin/dtexec'
